...
from loaders import Doc2DocIDDataModule
from models import Doc2DocidLayerWiseModel
...
def run(cfg):
    ...
    datamodule = Doc2DocIDDataModule(config=cfg, tokenizer=tokenizer)
    model = Doc2DocidLayerWiseModel(config=cfg, tokenizer=tokenizer)
